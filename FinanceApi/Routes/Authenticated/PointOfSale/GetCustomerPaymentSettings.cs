...
namespace FinanceApi.Routes.Authenticated.PointOfSale
{
    public class GetCustomerPaymentSettings : IRoute
    {
        ...
        public void Run(APIGatewayProxyRequest request, APIGatewayProxyResponse response, FinanceUser user)
        {
            ...
            string locationId = PropertyRentalManagement.Constants.LOCATION_ID_LAKELAND; // WARNING: location id should come from query parameters.
            ...
            var vendorClient = new DatabaseClient<PropertyRentalManagement.DatabaseModel.Vendor>(dbClient, logger);
